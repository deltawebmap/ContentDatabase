...
{
    public class FloatArraySerType : IBinarySerType
    {
        private float[] value;

        public FloatArraySerType(float[] value)
        {
            this.value = value;
        }

        public override short SerTypeId => CommitBuilders.Write.WriteCommitObject.SER_TYPE_FLOAT_ARRAY;
